...
export default function Projects() {
    return (
      <div>
        <h2>Projects</h2>
        <p>Here are some of the coolest programming projects I have built recently! Feel free to check out my github for other and older projects!</p>
        <h3>Harmonizer</h3>
        <DescriptionObjectHolder height={20}>
