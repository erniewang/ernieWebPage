...
export default function Ernie() {
    ...
    return (
      <div>
        ...
        <ContentObjectHolder height={48} images={imageData}></ContentObjectHolder>
        <p>
        ...
        <ContentObjectHolder height={40} images={images2}></ContentObjectHolder>
