...
export default function Ernie() {
    ...
    return (
      <div>
        ...
        <ContentObjectHolder height={48} images={imageData} range={[0,4]} phonemode={phoneMode} ></ContentObjectHolder>
        <p>
        ...
        <ContentObjectHolder height={40} images={imageData} range={[4,8]} phonemode={phoneMode} ></ContentObjectHolder>
